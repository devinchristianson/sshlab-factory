module github.com/devinchristianson/ssh-lab-factory/containerssh

go 1.21.0

replace go.containerssh.io/libcontainerssh => github.com/devinchristianson/libcontainerssh v0.5.1
